...
class SneakersController {
    static All(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const searchItem = yield services_1.SneakersService.All();
    ...
    static Create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const createItem = yield services_1.SneakersService.Create(item);
    ...
    static Delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const createItem = yield services_1.SneakersService.Delete(item);
